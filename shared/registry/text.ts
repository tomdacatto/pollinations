...
const TEXT_BASE_SERVICES = {
    ...
    "inclusionai/ling-3.0-flash-vl": {
        ...
        cost: {
            ...
            // the mandatory 5.5% OpenRouter credit fee. Image and video inputs
            // are tokenized into promptTextTokens; this route reports no
            // separate image/video usage.
        ...
        description:
            "Low-cost multimodal MoE with image, video understanding and tool calling",
        inputModalities: ["text", "image", "video"],
        outputModalities: ["text"],
        maxReferenceImages: 10,
        tools: true,
    ...
    "nvidia/nemotron-3-ultra": {
        ...
        description:
            "Frontier reasoning for coding agents, deep research and complex workflows",
        inputModalities: ["text"],
        outputModalities: ["text"],
        tools: true,
        reasoning: true,
    ...
    "z-ai/glm-5.3": {
        ...
        title: "Z.ai GLM-5.3",
        description:
            "Mandatory-reasoning model for complex software engineering and long-horizon agent workflows",
        inputModalities: ["text"],
        outputModalities: ["text"],
        tools: true,
        reasoning: true,
    ...
    "qwen/qwen3.8-27b": {
        ...
        title: "Qwen3.8 27B",
        description:
            "Dense multimodal reasoning for coding, tool use, and structured generation",
        inputModalities: ["text", "image", "video"],
        outputModalities: ["text"],
        maxReferenceImages: 10,
